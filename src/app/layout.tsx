...
export const metadata: Metadata = {
  title: "Lorenzo Noya - Master Italian Barber | Premium Barbershop",
  description: "Experience authentic Italian barbering with Lorenzo Noya. 20+ years of master craftsmanship, traditional techniques, and modern precision. Book your appointment today.",
  keywords: "Lorenzo Noya, Italian barber, master barber, premium barbershop, hot towel shave, beard grooming, classic haircut, traditional barbering",
  metadataBase: new URL("https://lorenzonoya.com"),
  alternates: {
    canonical: "https://lorenzonoya.com"
  },
  openGraph: {
    title: "Lorenzo Noya - Master Italian Barber",
    description: "Authentic Italian barbering with 20+ years of master craftsmanship. Experience the finest traditional techniques.",
    url: "https://lorenzonoya.com",
    siteName: "Lorenzo Noya Master Barber",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325805725-c8uofja0.jpg",
        alt: "Lorenzo Noya master barber"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Lorenzo Noya - Master Italian Barber",
    description: "Authentic Italian barbering with traditional techniques and modern precision.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763325805725-c8uofja0.jpg"]
  },
  robots: {
    index: true,
    follow: true
